	...
	<%@ include file="menu.jsp"%>
		...
		<form class="template-grid" action="filtrar-estabelecimentos" method="post">
			...
			<div id="filtros">
				...
				<select class="texto-grande" name="categoria">
				...
				<div class="card-filtros">
					...
					<hr>
					<select class="texto-grande" id="filtros-estado" name="nome-estado">
					...
					<input class="texto-grande" type="submit" value="Filtrar">
			</div>
		</form>
